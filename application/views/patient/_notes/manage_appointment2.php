		...
		<div class="tab-content">
			...
			<div class="tab-pane box active" id="edit" style="padding: 5px">
                <div class="box-content">
                    ...
                    <?php echo form_open('patient/manage_appointment/edit/'.$row['appointment_id'] , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('profissional');?></label>
                                <div class="controls" style="padding-top:6px;">
                                	<?php echo $this->crud_model->get_type_name_by_id('profissional' ,$this->session->userdata('patient_id') , 'name');?>
                                    <input type="hidden" name="profissional_id" value="<?php echo $this->session->userdata('patient_id');?>"  />
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select class="chzn-select" name="patient_id">
										...
										?>
                                        	<option value="<?php echo $row2['patient_id'];?>" <?php if($row['patient_id'] == $row['patient_id'])echo 'selected';?>>
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	...
                            	<a href="<?php echo base_url();?>index.php?patient/manage_appointment2/delete/<?php echo $row['appointment_id'];?>" onclick="return confirm('delete?')"
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open('profissional/manage_appointment/create/' , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('profissional');?></label>
                                <div class="controls" style="padding-top:6px;">
                                	<?php echo $this->crud_model->get_type_name_by_id('profissional' ,$this->session->userdata('profissional_id') , 'name');?>
                                    <input type="hidden" name="profissional_id" value="<?php echo $this->session->userdata('profissional_id');?>"  />
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('patient');?></label>
