		...
		<div class="tab-content">
			...
			<div class="tab-pane box active" id="edit" style="padding: 5px">
                <div class="box-content">
                    ...
                    <form method="post" action="<?php echo base_url();?>index.php?profissional/manage_prescription/edit/do_update/<?php echo $row['prescription_id'];?>" class="form-horizontal validatable">
                        <div class="padded">
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('profissinal');?></label>
                                <div class="controls" style="padding-top:5px;">
                                    <?php echo $this->crud_model->get_type_name_by_id('profissional',$row['profissional_id'],'name');?>
                                </div>
                            </div>
                            <div class="control-group">
