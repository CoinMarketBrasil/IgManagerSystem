            ...
            <div class="action-nav-normal">
                <div class="row-fluid">
                    ...
                    <div class="span2 action-nav-button">
                        ...
                        <span><?php echo get_phrase('Agendamentos');?></span>
                        </a>
                    </div>
                    <div class="span2 action-nav-button">
  ...
  $(document).ready(function() {
    ...
    $("#schedule_calendar").fullCalendar({
            ...
            events: [
                    ...
                    ?>
					{
						title: "<?php echo get_phrase('appointment').' : '.$this->crud_model->get_type_name_by_id('profissional' ,$row['profissional_id'], 'name' );?>",
