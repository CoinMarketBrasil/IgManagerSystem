	...
	<body>
                ...
                <div class="padded">
                    ...
                    <div class="login box" style="margin-top: 10px;">
                        ...
                        <i class="m-icon-swapright m-icon-white"></i>
                            ...
                            <div>
                              <button type="button" class="btn data-target=#Cadastro" >
        ...
        <<div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="http://localhost/processa_cad.php" enctype="multipart/form-data">
                  ...
                  <input type="radio" name="sex" id="M" value="Masculino"> Masculino  
                     </label>
            <label class="radio-inline">
                <input type="radio" name="sex" id="F" value="Feminino"> Feminino
                     </label>
            <label class="radio-inline">
                <input type="radio" name="sex" id="IN" value="IND"> Prefiro não responder
                    </label>
          </div>
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <textarea name="CPF" class="form-control"></textarea>
                                </div>
                                <div class="form-group">
