<div class="container-fluid padded">
        ...
        <div class="span30">
            ...
            <div class="action-nav-normal">
                <div class="row-fluid">
                  ...
                  <!----   <div class="span2 action-nav-button">
                        <a href="<?php echo base_url();?>index.php?profissional/consultas">
                        <i class="icon-hdd"></i>
                        <span><?php echo get_phrase('Consultas');?></span>
                        </a>
                    </div>  ---->
  ...
  $(document).ready(function() {
    ...
    $("#schedule_calendar").fullCalendar({
            ...
            events: [
					<?php 
                    $appointments	=	$this->db->get_where('appointment' , array('profissional_id' => $this->session->userdata('profissional_id')))->result_array();
