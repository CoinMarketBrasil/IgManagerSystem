...
/***MANAGE APPOINTMENTS******/
	function manage_appointment($param1 = '', $param2 = '', $param3 = '')
	{
		...
		if ($param1 == 'create') {
			...
			redirect(base_url() . 'index.php?patient/view_appointment', 'refresh');
		}
		...
		$page_data['page_name']    = 'manage_appointment2';
		$page_data['page_title']   = get_phrase('manage_appointment2');
		$page_data['appointments'] = $this->db->get_where('appointment', array(
			'patient_id' => $this->session->userdata('patient_id')
		))->result_array();
		$this->load->view('index', $page_data);
	...
	function view_doctor($param1 = '', $param2 = '', $param3 = '')
	{
		...
		$page_data['Profissionais']    = $this->db->get('profissional')->result_array();
	...
	function view_admit_history($param1 = '', $param2 = '', $param3 = '')
	{
		...
		$page_data['bed_allotments'] = $this->db->get_where('consult_allotment', array(
			'patient_id' => $this->session->userdata('patient_id')
		))->result_array();
		$this->load->view('index', $page_data);
	}
