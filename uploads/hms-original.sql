...
--
-- Host: 127.0.0.1
-- Generation Time: 30-Mai-2019 às 13:57
...
INSERT INTO `doctor` (`doctor_id`, `name`, `email`, `password`, `address`, `phone`, `especialidade_id`, `profile`) VALUES
...
(15, 'especialidade', 'especialidade', 'Departamento'),
...
(52, 'manage_especialidade', 'manage especialidade', 'Gerenciar departamento'),
(53, 'especialidade_list', 'especialidade list', 'Lista de departamento'),
(54, 'add_especialidade', 'add especialidade', 'Adicionar departamento'),
(55, 'especialidade_name', 'especialidade name', 'Nome do departamento'),
(56, 'description', 'description', 'Descrição'),
(57, 'options', 'options', 'Opções'),
(58, 'edit', 'edit', 'Editar'),
(59, 'delete', 'delete', 'Excluir'),
(60, 'especialidade_description', 'especialidade description', 'Eescrição departamento'),
